...
$customerid=$_SESSION['id'];
		mysqli_query($con,"insert into bill(method,customerid) values ('$method','$customerid')");
		unset($_SESSION['cart']);
		if($method=="COD")
		{
...
<div class="panel panel-default checkout-step-01">
	...
	<div id="collapseOne" class="panel-collapse collapse in">
	    ...
	    <input type="radio" name="paymethod" value="COD" checked="checked"> COD<br><br>
	     ...
	     <input type="radio" name="paymethod" value="Debit / Credit card"> Debit / Credit card <br /><br /><br>
