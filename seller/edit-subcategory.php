...
if(isset($_POST['submit']))
{
	...
	$id=intval($_GET['id']);
$sql=mysqli_query($con,"update subcategory set categoryid='$category',subcategory='$subcat',updationDate='$currentTime' where subcategoryid='$id'");
...
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select category.categoryid,category.categoryName,subcategory.subcategory from category,subcategory where category.categoryid=subcategory.categoryid and subcategory.subcategoryid='$id'");
