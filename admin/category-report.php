...
{ $todate=$_POST['todate'];
	$fromdate=$_POST['fromdate'];
$query=mysqli_query($con,"select category.categoryDescription as decs,category.categoryid,category.categoryName as category,category.creationDate,category.updationDate from category 
where
