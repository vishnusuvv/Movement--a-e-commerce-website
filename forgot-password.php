...
$query=mysqli_query($con,"SELECT * FROM customer WHERE email='$email' and phone='$contact'");
$num=mysqli_fetch_array($query);
if($num>0)
{
$extra="forgot-password.php";
mysqli_query($con,"update customer set pwd='$password' WHERE email='$email' and phone='$contact' ");
...
?>
		...
		<div class="form-group">
		 ...
		 <input type="text" name="contact" minlength='10' maxlength='10' class="form-control unicase-form-control text-input" id="contact" required>
		</div>
<div class="form-group">
