...
$sql=mysqli_query($con,"update bill set delstatus='$dstatus',status='$pstatus',deldate='$deldate' where billid='$oid'");
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <?php 
$ret = mysqli_query($con,"SELECT bill.deldate as deldate,bill.status as status,bill.billid as billid,bill.delstatus as delstatus FROM bill WHERE bill.billid='$oid'");
     ...
     ?>
       ...
       <tr height="30">
      <td class="fontkink1" ><b>Delivery To Be Done On:</b></td>
   ...
   <?php }else  {
     ...
     <tr style=''>
      ...
      <td class="fontkink" align="justify" ><span class="fontkink">
        <textarea cols="50" rows="7" name="pstatus"   ></textarea>
        </span></td>
    </tr>
    ...
    <tr height="50">
      ...
      <td  class="fontkink"><span class="fontkink1" >
        <select name="dstatus" class="fontkink"  >
