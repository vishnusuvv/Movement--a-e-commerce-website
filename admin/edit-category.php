...
$sql=mysqli_query($con,"update category set categoryName='$category',categoryDescription='$description',updationDate='$currentTime' where categoryid='$id'");
...
<?php
$id=intval($_GET['categoryid']);
$query=mysqli_query($con,"select * from category where categoryid='$id'");
