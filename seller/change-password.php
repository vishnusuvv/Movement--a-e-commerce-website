...
{
$sql=mysqli_query($con,"SELECT pwd FROM  seller where pwd='".$_POST['password']."' and email='".$_SESSION['alogin']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update seller set pwd='".$_POST['newpassword']."' where email='".$_SESSION['alogin']."'");
