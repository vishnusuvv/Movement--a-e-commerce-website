...
$corderid=intval($_GET['corderid']);
if(isset($_POST['submit2'])){
$dstatus=$_POST['dstatus'];
$ddate=$_POST['deldate'];
$pstatus=$_POST['pstatus'];//space char
$sql=mysqli_query($con,"update bill set delstatus='$dstatus',status='$pstatus',deldate='$ddate' where billid='$billid'");
if($sql){
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="30">
      <td  class="fontkink1"><b>Bill Id:</b></td>
      <td  class="fontkink pull-left"><?php echo $billid;?></td>
      
    </tr>
    <tr height="30">
      <td  class="fontkink1"><b>Order Id:</b></td>
      <td  class="fontkink pull-left"><?php echo $corderid;?></td>
      
    </tr>
    <?php 
$ret = mysqli_query($con,"SELECT bill.deldate as deldate,
bill.status as status,
bill.billid as billid,
bill.delstatus as delstatus,
morder.morderid as morderid,
morder.date as date FROM bill,
morder
 WHERE bill.billid='$billid' and 
 bill.billid=morder.morderid");
   ...
   <?php 
$st='Pickup Done';
   $rt = mysqli_query($con,"SELECT * FROM bill WHERE billid='$billid'");
   ...
   <?php }else  {
     ...
     <tr style=''>
      ...
      <td class="fontkink" align="justify" ><span class="fontkink">
        <textarea cols="50" value="<?php echo $row['status'];?>" rows="7" name="pstatus"  required="required" ></textarea>
        </span></td>
    ...
    <tr height="50">
      ...
      <td  class="fontkink"><span class="fontkink1" >
        <select name="dstatus" value="<?php echo $row['delstatus'];?>" class="fontkink" required="required" >
          <option value="<?php echo $row['delstatus'];?>">Select Status</option>
      ...
      <td class="fontkink1" >Delivery Date:</td>
          <td  class="fontkink">   
      <input name="deldate" value="<?php echo $row['deldate'];?>" type="date" class="txtbox4"  style="cursor: pointer;"  ></td>
