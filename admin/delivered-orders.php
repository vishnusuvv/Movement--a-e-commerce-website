...
<td><?php echo htmlentities($row['productname']);?></td>
											...
											<td><?php echo htmlentities($row['price']/100)*95;?></td>
											<td><?php echo htmlentities($row['deldate']);?></td>
											<td>    <a href="updateorder1.php?oid=<?php echo htmlentities($row['billid']);?>" title="Update order" target="_blank"><i class="icon-edit"></i></a>
											</td>
											</tr>
							...
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							&nbsp;&nbsp;&nbsp;
							&nbsp;<a href="delivered-report.php">GENERATE DATE WISE REPORT </a><br><br>
						</div>						
