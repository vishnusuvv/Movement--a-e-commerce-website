...
where products.sellerid=seller.sellerid and seller.sellerid=morder.sellerid and seller.sellerid=bill.sellerid AND morder.customerid=customer.customerid and bill.customerid=customer.customerid and  corder.morderid=morder.morderid  and  seller.email='".$_SESSION['alogin']."'
Between '$from' and '$to' ");
$cnt=1;
