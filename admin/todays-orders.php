			...
			<table cellpadding="0" cellspacing="0" border="0" class="datatable-1  table-bordered table-striped	 display table-responsive" >
									<thead>
										<tr>
											...
											<th width="50">Order id/Bill id</th>
...
$t1="23:59:59";
$to=date('Y-m-d')." ".$t1;
$query=mysqli_query($con,"select bill.billid, products.productName as productname,
corder.qty as qty,
...
from morder join customer on morder.customerid=customer.customerid, seller,bill,corder ,products

where products.sellerid=seller.sellerid and seller.sellerid=morder.sellerid and seller.sellerid=bill.sellerid AND morder.customerid=customer.customerid and bill.customerid=customer.customerid and  corder.morderid=morder.morderid 
Between '$from' and '$to' ");
$cnt=1;
...
?>										
										<tr>
											...
											<td><?php echo htmlentities($row['cust']);?></td>
