...
if($num>0)
{
$query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,corder.productid as opid,corder.qty as qty,products.sellingprice as pprice,morder.date as odate,corder.corderid as corderid,morder.morderid as morderid from corder join products on corder.productid=products.productid where morders.morderid='$orderid' and orders.paymentMethod is not null");
$cnt=1;
