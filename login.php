...
$email=$_POST['emailid'];
	...
	$fname=$_POST['fname'];
	$lname=$_POST['lname'];
	$phone=$_POST['contachno'];
$query=mysqli_query($con,"INSERT INTO customer(email, pwd, fname, lname, phone) 
					VALUES ('$email','$pwd','$fname','$lname','$phone')");
		...
		<div class="form-group">
		 ...
		 <input type="password" name="password" class="form-control unicase-form-control text-input" id="exampleInputPassword1" required>
	  	...
	  	<div class="radio outer-xs">
		  	<a href="seller/index.php" class="forgot-password pull-right">Are You A Seller?</a>
		</div>
		<div class="radio outer-xs">
		  <br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>	<a href="admin/index.php" class="btn btn-primary pull-left">Admin?</a>
		</div>
	</form>					
</div>
...
<div class="form-group">
	    	<label class="info-title" for="fullname">First Name <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input" 
	    	id="firstname" name="fname" required="required">
	  	</div>
	  	<div class="form-group">
	    	<label class="info-title" for="lastname">Last Name <span>*</span></label>
	    	<input type="text" class="form-control unicase-form-control text-input"
	    	 id="lastname" name="lname" required="required">
	  	</div>
...
<div class="form-group">
	    	...
	    	<input type="text" class="form-control unicase-form-control text-input" 
	    	pattern="{0-9}" id="contactno" name="contactno" maxlength='10' minlength='10' required >
	  	</div>
